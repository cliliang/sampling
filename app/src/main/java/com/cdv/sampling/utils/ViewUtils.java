...
public class ViewUtils {
    ...
    public static Bitmap getViewBitmap(View view, int width, int height) {
        ...
        Bitmap b = Bitmap.createBitmap((int) (height / density), (int) (width / density), Bitmap.Config.RGB_565);
        Canvas c = new Canvas(b);
        Matrix matrix = new Matrix();
        matrix.preScale(1.0f / density, 1.0f / density);
        matrix.preRotate(90);
        matrix.postTranslate((int) (height / density), 0);
        c.setMatrix(matrix);
        view.draw(c);
        return b;
    }
